...
Window {
    ...
    minimumHeight: Math.max(mainLayout.Layout.minimumHeight + 2 * myMargin, Screen.height * 0.4)
    ...
    ColumnLayout {
        ...
        SplitView {
            ...
            Layout.minimumHeight: root.minimumWidth - (2 * myMargin)

            Rectangle {
                id: filesList
                SplitView.fillWidth: true
                SplitView.preferredWidth: root.width / 4    // TODO: change if loaded with data
...
//                                       "WaypointsView contentWidth", waypointsView.contentWidth)
            ...
            Button {
                ...
                text: qsTr("SplitView")
                onClicked: console.log("splitView.contentHeight =", splitView.contentHeight,
                                       "splitView.height = ", splitView.height, "\n",
                                       "splitView.contentWidth =", splitView.contentWidth,
